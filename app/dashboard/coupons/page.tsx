    ...
    <div className="max-w-5xl mx-auto p-8 pb-24 text-gray-800">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border mb-8">
        ...
        <form action={addCoupon} className="flex gap-4">
          <input name="code" placeholder="Code (e.g. SAVE20)" className="p-3 border rounded flex-1 uppercase" required />
          <input name="discount" type="number" placeholder="Discount %" className="p-3 border rounded w-32" required />
